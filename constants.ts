...
export const MOCK_JOBS: JobApplication[] = [
  {
    id: '1',
    company: 'Horizon E-Com',
    role: 'Senior Frontend Engineer',
    status: JobStatus.INTERVIEW,
    dateApplied: '2023-10-01',
    lastUpdated: '2023-10-05',
    link: 'https://horizon.example.com/careers',
    notes: '### Interview Notes\n- Spoke with Sarah (CTO)\n- Focus on React performance and state management.\n- **Next step:** Technical round on Tuesday.',
  ...
  },
  {
    ...
    link: 'https://nebula.ai/jobs',
    notes: 'Applied via referral. Need to follow up in 3 days if no response.',
  ...
  },
  {
    ...
    notes: 'Rejected after screening. Feedback: "Looking for more Go experience."',
    location: 'Hybrid (NYC)',
  },
  {
    id: '4',
    ...
    notes: '**OFFER RECEIVED**\n- Base: $170k\n- Equity: 0.1%\n- Signing: $10k\n\nNeed to negotiate the signing bonus.',
    nextAction: 'Negotiate Offer',
    nextActionDate: '2023-10-08',
    location: 'Remote',
    salary: '$170k'
  },
  {
    id: '5',
    company: 'BlueOrigin Subs',
    role: 'UI Engineer',
    status: JobStatus.APPLIED,
    dateApplied: '2023-10-07',
    lastUpdated: '2023-10-07',
    notes: 'Quick apply via LinkedIn.',
    location: 'Seattle',
  }
];
...
export const BACKEND_CODE_TEMPLATE = `/**
